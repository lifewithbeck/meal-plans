...
const WEEKS = {
  ...
  // ═══════════════════════════════════════════════════
  // ADD NEW WEEKS BELOW — copy the structure above
  // Example:
  // "S13-S14": {
  //   label: "S13-S14",
  //   dates: "23-29 Martie 2026",
  //   subRecipes: { ... },
  //   meals: { ... },
  //   days: [ ... ],
  // },
      ...
      <div style={{
        ...
        <div style={{display:"grid", gridTemplateColumns:"repeat(3,1fr)", gap:10}}>
          {[1,2,3,4,5,6,7,8,9].map(d => (
            <button key={d} onClick={() => handleKey(String(d))} style={{
              padding:"16px 0", fontSize:18, fontWeight:"bold",
...
function WeekSelector({ weeks, active, onSelect }) {
  ...
  if (keys.length === 1) return null; // hide if only one week
  return (
